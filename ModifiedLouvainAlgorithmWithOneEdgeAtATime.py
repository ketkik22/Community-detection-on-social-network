...
while isLocalMaximaAchievedCount >= 0:
    ...
    plot(outputGraph, "outputGraph%d.png" %idx, mark_groups=True)
    idx += 1

print("Final index = %d"%index)
print("%d final  Modularity = %f" %(idx,maxModularity))